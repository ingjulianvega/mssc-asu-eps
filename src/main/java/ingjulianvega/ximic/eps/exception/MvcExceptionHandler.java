...
import ingjulianvega.ximic.eps.configuration.EpsParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    public MvcExceptionHandler(EpsParameters epsParameters) {
        this.epsParameters = epsParameters;
    }

    EpsParameters epsParameters;


    @ExceptionHandler(EpsException.class)
    public ResponseEntity<ApiError> validationErrorHandler(EpsException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(epsParameters.getApi())
